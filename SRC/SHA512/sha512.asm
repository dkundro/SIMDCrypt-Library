...
section .data
	...
	constAB:  
		dq  0x6a09e667f3bcc908 ;A
	  	dq  0xbb67ae8584caa73b ;B
	constCD:
	  	dq  0x3c6ef372fe94f82b ;C
		dq  0xa54ff53a5f1d36f1 ;D
	constEF:  
	  	dq  0x510e527fade682d1 ;E
		dq  0x9b05688c2b3e6c1f ;F
	constGH:
		dq  0x1f83d9abfb41bd6b ;G
		dq  0x5be0cd19137e2179 ;H
...
sha512_ASM:
	...
	; Pido memoria donde almacenar el resultado hasheado (64 bytes)
	MOV RDI, 64
	CALL malloc
